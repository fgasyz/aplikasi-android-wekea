    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.productContainer}>
        ...
        <View style={styles.ratingContainer}>
          ...
          <View style={styles.stars}>
            {Array.from({length: 5}).map((_, index) => {
              const starColor =
                index < detailProductList.averageRating
                  ? Colors.yellow
                  : '#aaa';
              return (
                <Ionicons key={index} name="star" size={20} color={starColor} />
              );
            })}
          </View>
          <Text style={styles.countReviewText}>
            ({detailProductList.countReview} reviews)
          </Text>
        </View>
        ...
        <View
          ...
          <View>
            <Text
              style={[styles.priceText, {textDecorationLine: 'line-through'}]}>
              Rp.{' '}
              {new Intl.NumberFormat('id-ID', {
                style: 'decimal',
                currency: 'IDR',
              }).format(detailProductList.price)}
            </Text>
